...
/**
 * This project component adds a small panel at the top of a text editor to show information about
 * file size, character count and line count.
 *
 * This is a short demonstration how to track editor handling in IntelliJ.
 *
 * @author jansorg
 */
            ...
            public void fileOpened(@NotNull FileEditorManager manager, @NotNull VirtualFile file) {
                ...
                document.addDocumentListener(new DocumentListener() {
                    ...
                    public void documentChanged(DocumentEvent event) {
                        label.setText(statusMessage(event.getDocument(), FileDocumentManager.getInstance().getFile(event.getDocument())));
                    }
                }, fileEditor);
            }
        });
